...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      rows: 2,
      group: 'general',
      description: 'Define el resultado que obtiene el cliente. Se usa en Schema.org (Service).',
      hidden: ({ document }) => !document?.isCoreService,
    }),
    defineField({
      name: 'audience',
      ...
      rows: 2,
      group: 'general',
      description: 'Define el público objetivo. Se usa en Schema.org (Service).',
      hidden: ({ document }) => !document?.isCoreService,
    }),
    defineField({
      name: 'isCoreService',
