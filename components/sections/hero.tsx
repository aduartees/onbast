    ...
    <div className="h-screen w-full rounded-md bg-neutral-950 relative flex flex-col items-center justify-center antialiased">
      <div className="max-w-4xl mx-auto p-4 relative z-10 flex flex-col items-center text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-8 relative z-10 w-full sm:w-auto">
          <Button size="lg" className="bg-white text-black hover:bg-neutral-200 w-full sm:w-auto" asChild>
            <Link href="/contacto" title="Comenzar Proyecto">
              Comenzar Proyecto
            </Link>
          </Button>
          <Button size="lg" variant="outline" className="border-neutral-700 text-white hover:bg-neutral-800 w-full sm:w-auto" asChild>
            <Link href="/proyectos" title="Ver Casos de Éxito">
              Ver Casos de Éxito
            </Link>
          </Button>
        </div>
