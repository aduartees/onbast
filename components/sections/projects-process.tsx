...
export function ProjectsProcess({ steps }: { steps: ProcessStep[] }) {
      ...
      >
          ...
          <div className="w-full md:w-1/2 p-6 md:p-16 flex flex-col justify-center relative z-10 order-2 md:order-1">
             <div className="absolute top-6 left-6 md:top-12 md:left-12">
                <span className="text-xs md:text-sm font-mono text-neutral-400 uppercase tracking-widest border border-white/10 px-3 py-1 rounded-full bg-black/50 backdrop-blur-md">
