...
import { COOKIES_PAGE_QUERY } from "@/sanity/lib/queries";
...
export async function generateMetadata(): Promise<Metadata> {
  const data = await client.fetch<CookiesQueryResult>(COOKIES_PAGE_QUERY, {}, { next: { revalidate: 60 } });
