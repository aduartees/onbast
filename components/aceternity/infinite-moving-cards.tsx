  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[350px] max-w-full relative rounded-2xl border border-white/5 bg-neutral-900/50 backdrop-blur-md px-8 py-6 md:w-[450px] shadow-[0_8px_32px_0_rgba(0,0,0,0.36)]"
            key={item.name + idx}
          >
            <blockquote>
              <div
